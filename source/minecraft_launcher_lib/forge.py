...
def run_forge_installer(version: str, minecraft_directory: str, java: Optional[str] = None, callback: Optional[dict] = {}) -> None:
    """
    ...
    temp_file_path = os.path.join(tempfile.gettempdir(), f"forge-{random.randrange(100,10000)}.tmp")
    download_file(FORGE_DOWNLOAD_URL.format(version=version), temp_file_path, callback=callback)
